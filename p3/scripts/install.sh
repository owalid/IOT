...
function install_kubectl
{
    ...
    if [ ! -d /home/taskmasters/.kube ];then
        message ".kube directory does not exist. We will create it."
        mkdir /home/taskmasters/.kube
    fi
...
function install_and_configure_argo_cd
{
    ...
    grep -xq 'export ARGOCD_OPTS='--port-forward-namespace argocd'' /home/taskmasters/.bashrc
    if [ ! $? -eq 0 ];then
        echo "export ARGOCD_OPTS='--port-forward-namespace argocd'" >> /home/taskmasters/.bashrc
        source /home/taskmasters/.bashrc
    fi
    sleep 2
